...
const Color darkWarmBrown = Color(0xFF4A4039);

const Color deepBurgundyRed = Color(0xFF8C2F3A);

const Color softOffWhite = Color.fromARGB(255, 247, 248, 255);

const Color charcoalDarkGray = Color(0xFF333333);

const Color mediumGray = Color(0xFF555555);

const Color mutedGreen = Color(0xFF5D9566);
...
const Color deepNavyBlack = Color.fromRGBO(17, 18, 27, 1);
...
const List colorsOfBookmarks2 = [Colors.greenAccent, Colors.redAccent, Colors.blueAccent];
const List zikrNotfications = [
  '(ﷺ  صلي علي محمد)',
...
var languagesLetters = [
  ...
  {'en': List.generate(26, (index) => String.fromCharCode('A'.codeUnitAt(0) + index))},
  {'de': List.generate(26, (index) => String.fromCharCode('A'.codeUnitAt(0) + index))},
  {
    'am': [
      'አ',
      'ብ',
  ...
  {'ms': List.generate(26, (index) => String.fromCharCode('A'.codeUnitAt(0) + index))},
  {'pt': List.generate(26, (index) => String.fromCharCode('A'.codeUnitAt(0) + index))},
  {'tr': List.generate(29, (index) => String.fromCharCode('A'.codeUnitAt(0) + index))},
  {'ru': List.generate(33, (index) => String.fromCharCode('A'.codeUnitAt(0) + index))}
];
