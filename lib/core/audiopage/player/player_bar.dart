                        ...
                        child: Material(
                          ...
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              height:
                                  statee.height == 60 ? 60.h : (MediaQuery.of(context).size.height),
                                        ...
                                        children: [
                                          ...
                                          StreamBuilder<SequenceState?>(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                if (statee?.sequence.isEmpty ?? true) {
                                                  return const SizedBox();
                                                }
                                                final metadata =
                                                    statee!.currentSource!.tag as MediaItem;
                                                if (snapshot.hasData) {
                                                  return Text(
                                          ...
                                          if (state.audioPlayer.playing == false)
                                            GestureDetector(
                                              onTap: () {
                                                BlocProvider.of<PlayerBarBloc>(context)
                                                    .add(CloseBarEvent());
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding:
                                                        EdgeInsets.only(top: 12.0.h, left: 12.w),
                                                    child: IconButton(
                                                      onPressed: () {
                                                        BlocProvider.of<PlayerBarBloc>(context)
                                                            .add(MinimizeBarEvent());
                                                      },
                                                      icon: Icon(LineariconsFree.chevron_down,
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  return Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        textDirection: m.TextDirection.rtl,
                                                        metadata.album!.replaceAll('القارئ', ''),
                                                        style: TextStyle(
                                                                        ...
                                                                        child: CircleAvatar(
                                                                            radius:
                                                                                isPlaylistShown ==
                                                                                    ...
                                                                                    : 60.r,
                                                                            foregroundImage: getValue(
                                                                                        "${metadata.album!.replaceAll("القارئ ", "")} photo url") !=
                                                                                    null
                                                                                ? CachedNetworkImageProvider(
                                                                                    getValue(
                                                                                        "${metadata.album!.replaceAll("القارئ ", "")} photo url"),
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return Row(
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: SliderTheme(
                                                        data: SliderTheme.of(context).copyWith(
                                                          ...
                                                          thumbColor:
                                                              Colors.white, // Customize thumb color
                                                    ...
                                                    SizedBox(
                                                        child: Text(
                                                      formatDuration(state.audioPlayer.duration!),
                                                      textDirection: m.TextDirection.rtl,
                                            ...
                                            if (isPlaylistShown == false) SizedBox(height: 60.0.h),
                                            if (isPlaylistShown == false)
                                              Padding(
                                            ...
                                            if (isPlaylistShown == false) SizedBox(height: 15.0.h),
                                            if (isPlaylistShown == true) SizedBox(height: 20.0.h),
                                                    ...
                                                    builder: (context, snapshot) {
                                                      ...
                                                      return ReorderableListView(
                                                        onReorder: (int oldIndex, int newIndex) {
                                                          ...
                                                          state.playList.move(oldIndex, newIndex);
                                                        },
                                                        children: [
