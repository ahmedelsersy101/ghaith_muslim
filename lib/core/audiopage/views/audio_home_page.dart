...
// print(jsonData3);
  ...
  void filterReciters(String query) {
    ...
    itemScrollController.scrollTo(index: 0, duration: const Duration(seconds: 1));
  }
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          color: const Color(0xffF6F6F6), borderRadius: BorderRadius.circular(5.r)),
                      child: Row(
                        children: [
                          Expanded(
                            child: Padding(
                                                  ...
                                                  children: [
                                                    EasyContainer(
                                                      ...
                                                      onTap: () async {
                                                        ...
                                                        // }).toList();
                                                        getRewayaReciters(selectedMode);
                                                        print(filteredReciters.length);
                                                        setState(() {
                                              ...
                                              onPressed: () {
                                                if (favoriteRecitersList.contains(reciter)) {
                                                  ...
                                                  updateValue("favoriteRecitersList",
                                                      json.encode(favoriteRecitersList));
                                                } else {
                                                          ...
                                                          children: [
                                                            Row(
                                                              children: [
                                                                ...
                                                                SizedBox(
                                                                  width: (screenSize.width * .5).w,
                                                                  child: Text(
                                                                    e.name,
                                                                    overflow: TextOverflow.ellipsis,
                                                                    style: TextStyle(
                                                                        color: isDarkModeNotifier
                                                                                .value
                                                                            ? Colors.white
                                                                                .withOpacity(.87)
                                                                            : Colors.black87,
