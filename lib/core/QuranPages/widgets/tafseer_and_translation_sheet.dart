...
class _TafseerAndTranslateSheetState extends State<TafseerAndTranslateSheet> {
  ...
  getData() async {
    data = await getVerseTranslation(widget.surahNumber, widget.verseNumber + verseNumber,
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    convertToArabicNumber((widget.verseNumber + verseNumber).toString()),
                    style: TextStyle(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: ListView.separated(
                                        ...
                                        itemBuilder: (c, i) {
                                          return Container(
                                            color: i == getValue("indexOfTranslation")
                                                ? Colors.blueGrey.withOpacity(.1)
                                                : Colors.transparent,
                                            child: InkWell(
                                              onTap: () async {
                                                if (isDownloading != translationDataList[i].url) {
                                                  if (File("${appDir!.path}/${translationDataList[i].typeText}.json")
                                                          .existsSync() ||
                                                      i == 0 ||
                                                      i == 1) {
                                                    updateValue("indexOfTranslation", i);
                                                    setState(() {});
                                                    getData();
                                                    ...
                                                    PermissionStatus status2 = await Permission
                                                    ...
                                                    await Dio().download(translationDataList[i].url,
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                                color: Colors.black,
                                fontFamily: translationDataList[getValue("indexOfTranslation") ?? 0]
            ...
            Divider(height: 30.h, color: Colors.black.withOpacity(.2)),

            // if (verseNumber != 0 && surahNumber != 0)
            Directionality(
              textDirection:
                  translationDataList[getValue("indexOfTranslation")].typeInNativeLanguage ==
                          "العربية"
                      ? m.TextDirection.rtl
                      : m.TextDirection.ltr,
              child: Padding(
