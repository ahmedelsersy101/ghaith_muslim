...
class _ScreenShotPreviewPageState extends State<ScreenShotPreviewPage> {
  ...
  getTranslationData() async {
    if (getValue("addTafseerValue") > 1) {
      File file =
          File("${appDir!.path}/${translationDataList[getValue("addTafseerValue")].typeText}.json");
  ...
  List<InlineSpan> buildVerseSpans(int surahNumber, int firstVerseNumber, int lastVerseNumber) {
    ...
    for (int verseNumber = firstVerseNumber; verseNumber <= lastVerseNumber; verseNumber++) {
      ...
      String verseText =
          isQCF ? getVerseQCF(surahNumber, verseNumber) : getVerse(surahNumber, verseNumber);
      if (verseNumber == firstVerseNumber) {
        // print("true");
        // verseText.replaceFirst(" ", "\n");
        if (verseText.length > 15 || firstVerseNumber != lastVerseNumber && verseText.length > 4) {
  ...
  Future<List<InlineSpan>> buildTafseerSpans(
      int surahNumber, int firstVerseNumber, int lastVerseNumber, translatee) async {
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    ...
                                    children: buildVerseSpans(
                                        widget.surahNumber, widget.firstVerse, widget.lastVerse),
                                  ),
                                ),
                              ),
                            ),
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                            ...
                                            color: backgroundColors[indexOfTheme].withOpacity(.6)),
                                      ),
                                      Text(
