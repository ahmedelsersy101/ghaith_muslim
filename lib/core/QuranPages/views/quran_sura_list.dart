        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(
                fontSize: 14.sp,
                color:
                    isDarkModeNotifier.value ? primaryColor : const Color.fromARGB(228, 0, 0, 0)),
          ),
        ),
      );
    } else if (index == 1) {
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              onChanged: (value) {
                                ...
                                if (searchQuery.isNotEmpty && isInt(searchQuery)) {
                                ...
                                if (searchQuery.length > 3 ||
                                  ...
                                  setState(() {
                                    ...
                                    filteredData = widget.jsonData.where((sura) {
                                      ...
                                      //         .toLowerCase();
                                      final suraNameTranslated =
                                          quran.getSurahNameArabic(sura["number"]);
            ...
            return Card(
              ...
              child: Padding(
                ...
                child: ListTile(
                    title: Text(
                      quran
                          .getSurahNameArabic(quran.getSurahAndVersesFromJuz(index + 1).keys.first),
                      style: TextStyle(
                          color: isDarkModeNotifier.value
                ...
                child: ListTile(
                  title: Text(
                    quran.getSurahNameArabic(
                        widget.quarterjsonData[indexes[index.section][index.index] - 1]["surah"]),
                    style: TextStyle(
                        color: isDarkModeNotifier.value
                            ? const Color.fromARGB(234, 255, 255, 255)
                            : const Color.fromARGB(228, 0, 0, 0)),
                  ...
                  subtitle: Text(
                    quran.getVerse(
                        widget.quarterjsonData[indexes[index.section][index.index] - 1]["surah"],
                        widget.quarterjsonData[indexes[index.section][index.index] - 1]["ayah"]),
                    style: TextStyle(
                        fontFamily: "UthmanicHafs13",
                        fontSize: 18.sp,
                        color: isDarkModeNotifier.value
              ...
              children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(quran.getSurahName(
                                    quran.getPageData(pageNumbers[index])[0]["surah"]))
                              ],
                            ),
                          ),
                        ),
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String suraNameTranslated = filteredData[index]["name"].toString();
                          ...
                          child: Row(
                            children: [
                              ...
                              if (bookmarks.indexWhere((a) {
                                ...
                                Icon(Icons.bookmark,
                                    size: 16.sp,
                                    color: colorsOfBookmarks2[bookmarks.indexWhere((a) {
                                      return a.toString().startsWith("$suraNumberInQuran");
                                    })]
                                        .withOpacity(.7))
                            ],
                          ),
                ...
                if (ayatFiltered != null)
                  ListView.builder(
                    physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemCount: ayatFiltered["occurences"] > 10 ? 10 : ayatFiltered["occurences"],
                    itemBuilder: (context, index) {
                      return Padding(
