...
class Hadith {
  ...
  factory Hadith.fromJson(Map<String, dynamic> json) => Hadith(
        ...
        wordsMeanings:
            json['words_meanings'] != null || json['words_meanings'] != []
                ? List<WordsMeaning>.from(
                    json['words_meanings'].map((x) => WordsMeaning.fromJson(x)))
                : [],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'words_meanings':
            List<dynamic>.from(wordsMeanings.map((x) => x.toJson())),
        'reference': reference,
      };
}
