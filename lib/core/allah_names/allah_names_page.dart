...
import 'package:ghaith/core/allah_names/data/allah_names.dart';
...
class _AllahNamesPageState extends State<AllahNamesPage> {
  ...
  testPrayer() {
    ...
    final myCoordinates =
        Coordinates(30.044420, 31.235712); // Replace with your own location lat, lng.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          isDarkModeNotifier.value ? quranPagesColorDark : quranPagesColorLight.withOpacity(0.3),
      appBar: AppBar(
        elevation: 0,
        ...
        actions: [
          IconButton(
              ...
              icon: Icon(isGrid == false ? ModernPictograms.th : ModernPictograms.th_list))
        ],
        title: Text(
          "asmaa".tr(),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                  image: AssetImage("assets/images/nameborder.png"))),
                          child: Center(
                            child: Text(
                              allahNamesAr[index]["name"],
                              style: TextStyle(color: const Color(0xffe0cb8a), fontSize: 20.sp),
                            ),
                          ),
                        ),
                      );
