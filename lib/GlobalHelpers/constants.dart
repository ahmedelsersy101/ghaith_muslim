...
const Color accentColor = Color(0xFF8C2F3A);
...
const Color goldColor = Color(0xFF8C2F3A);
...
List colorsOfBookmarks2 = [Colors.greenAccent, Colors.redAccent, Colors.blueAccent];
